...
export const NewsLetter = () => {
  return (
<div className='flex flex-col items-center justify-center text-center space-y-2my-32 relative bottom-10'>
    <h1 className='md: text-4x1 text-2x1 font-semibold'>Never Miss a Blog !
</h1>
