...
const Footer = () => {
  return (
    <div className='px- 6 md:px-16 bg-gray-100 lg:px-24 xl:px-32 bg:primary/3'>
        ...
        <div className='relative top-10 flex flex-row md:flex-col gap-8 left-0 right-0 '>
        ...
        <div className='flex relative  top-9  bottom-10 flex-wrap justify-between w-full md:w-[45%] gap-5'>
